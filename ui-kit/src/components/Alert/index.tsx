...
> = {
  ...
  feature: { base: 'bg-primary-base', soft: 'bg-feature-soft', weak: 'bg-feature-weak', weakDark: 'dark:bg-feature-soft', ring: 'ring-primary-base', accent: 'text-primary-base' },
}
...
export default function Alert({
  ...
  const container =
    variant === 'filled'
      ...
      : variant === 'light'
        ...
        : variant === 'stroke'
          ? cn('bg-bg-white-0 text-text-strong-950 ring-1 ring-inset ring-stroke-sub-300')
  ...
  return (
    <div className={cn('flex w-full gap-3 rounded-2xl p-4', container, className)} role="alert">
